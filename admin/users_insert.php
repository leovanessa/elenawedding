<?php
    ...
    $query="insert into users (name, surname, email, number, vacancy) values ('" .$name. "','" .$surname. "','".$email."','".(int)$number."',".(int)$vacancy.")";


    if(mysqli_query($con, $query)){

        if($num_errori==0)
            $resultQuery = "inserimento effettuato correttamente!<br /><br />";

        else
            $resultQuery = "Si sono verificati dei problemi nell'inserimento.<br><br>";
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> inserimento invitati 
                        </div>
                        <!-- /.panel-heading -->
