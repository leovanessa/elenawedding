...
bbcode = new Array();
bbtags = new Array('<b>','</b>','<span class=\"titolo_testo\">','</span>','<u>','</u>','<ul><li>','</li></ul>','<ol>','</ol>','','<br>', '<li>', '</li>', '<center>', '</center>', '<a href=\"inserisci qui il link\" target=\"blank\">', '</a>');
imageTag = false;
...
function checkForm() {
	...
	if (document.frm.testo.value.length < 2) {
...
function emoticon(text) {
	var txtarea = document.frm.testo;
	text = ' ' + text + ' ';
